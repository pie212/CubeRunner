...
public class InfinteplacerOBARCH : MonoBehaviour
{
    ...
    {            
            ...
            if (FindObjectOfType<InfinteplacerARCH>().type == 1 ||FindObjectOfType<InfinteplacerARCH>().type == 2 ||FindObjectOfType<InfinteplacerARCH>().type == 3 ||FindObjectOfType<InfinteplacerARCH>().type == 4 ||FindObjectOfType<InfinteplacerARCH>().type == 5)
            {
            ...
            if (FindObjectOfType<InfinteplacerARCH>().type == 5 ||FindObjectOfType<InfinteplacerARCH>().type == 6 ||FindObjectOfType<InfinteplacerARCH>().type == 7 ||FindObjectOfType<InfinteplacerARCH>().type == 8 ||FindObjectOfType<InfinteplacerARCH>().type == 9 ||FindObjectOfType<InfinteplacerARCH>().type == 10)
            {   
